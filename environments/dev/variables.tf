...
variable "availability_zones" {
  description = "List of availability zones - DEV uses only 2 AZs for cost savings"
  type        = list(string)
  default     = ["us-east-1a", "us-east-1b"]
}

variable "private_subnet_cidrs" {
  description = "CIDR blocks for private subnets - DEV uses only 2 AZs"
  type        = list(string)
  default     = ["10.1.1.0/24", "10.1.2.0/24"]
}

variable "public_subnet_cidrs" {
  description = "CIDR blocks for public subnets - DEV uses only 2 AZs"
  type        = list(string)
  default     = ["10.1.101.0/24", "10.1.102.0/24"]
}

variable "database_subnet_cidrs" {
  description = "CIDR blocks for database subnets - DEV uses only 2 AZs"
  type        = list(string)
...
variable "enable_vpc_flow_logs" {
  description = "Enable VPC Flow Logs to S3 - DISABLED in DEV for cost savings"
  type        = bool
  default     = false
}
...
variable "node_groups" {
  description = "EKS managed node group configurations - DEV uses smaller instances and single node"
  type = map(object({
...
variable "alarm_sns_topic_arn" {
  description = "SNS topic ARN for CloudWatch alarms - typically empty for DEV"
  type        = string
  default     = ""
}

variable "enable_container_insights" {
  description = "Enable CloudWatch Container Insights for EKS - DISABLED in DEV for cost savings"
  type        = bool
  default     = false
}
...
variable "budget_amount" {
  description = "Monthly budget amount in USD for cost alerts - DEV uses lower budget"
  type        = number
  default     = 5
...
variable "enable_automated_backups" {
  description = "Enable automated EBS snapshots - DISABLED in DEV"
  type        = bool
  default     = false
}

variable "backup_retention_days" {
  description = "Number of days to retain automated backups - DEV uses shorter retention"
  type        = number
  default     = 1
...
#######################################
# RDS PostgreSQL Configuration - DEV Optimized
#######################################
variable "rds_instance_class" {
  description = "RDS instance class for PostgreSQL - DEV uses smallest instance"
  type        = string
...
variable "rds_allocated_storage" {
  description = "Allocated storage for RDS in GB - DEV uses minimum"
  type        = number
  default     = 20
...
variable "rds_max_allocated_storage" {
  description = "Maximum storage for RDS autoscaling in GB - DEV uses lower max"
  type        = number
  default     = 50
...
variable "rds_backup_retention_period" {
  description = "Backup retention period for RDS in days - DEV uses minimal retention"
  type        = number
  default     = 1
...
variable "rds_multi_az" {
  description = "Enable multi-AZ deployment for RDS - DISABLED in DEV for cost savings"
  type        = bool
  default     = false
}
...
variable "rds_skip_final_snapshot" {
  description = "Skip final snapshot when destroying RDS - ENABLED in DEV for faster teardown"
  type        = bool
  default     = true
}

#######################################
# ElastiCache Redis Configuration - DEV Optimized
#######################################
variable "redis_node_type" {
  description = "ElastiCache Redis node type - DEV uses smallest instance"
  type        = string
...
variable "redis_num_cache_nodes" {
  description = "Number of cache nodes for Redis - DEV uses single node"
  type        = number
  default     = 1
...
variable "redis_automatic_failover_enabled" {
  description = "Enable automatic failover for Redis - DISABLED in DEV (requires multi-node)"
  type        = bool
  default     = false
}

variable "redis_multi_az_enabled" {
  description = "Enable multi-AZ for Redis - DISABLED in DEV for cost savings"
  type        = bool
  default     = false
}
