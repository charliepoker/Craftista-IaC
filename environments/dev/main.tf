#######################################
# Development Environment - Main Infrastructure
# This is a cost-optimized version of production
#######################################
...
module "eks" {
  ...
  # Cluster logging - reduced logs for dev
  ...
  # Cluster encryption - using AWS managed key for dev
...
#######################################
# VPC Endpoints - Essential ones only for dev
#######################################
