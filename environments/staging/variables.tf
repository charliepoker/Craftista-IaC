# Staging Environment - Variable Definitions
...
variable "availability_zones" {
  description = "List of availability zones - STAGING uses 3 AZs like production"
  type        = list(string)
  default     = ["us-east-1a", "us-east-1b", "us-east-1c"]
}

variable "private_subnet_cidrs" {
  description = "CIDR blocks for private subnets - STAGING uses 3 AZs"
  type        = list(string)
  default     = ["10.2.10.0/24", "10.2.20.0/24", "10.2.30.0/24"]
}

variable "public_subnet_cidrs" {
  description = "CIDR blocks for public subnets - STAGING uses 3 AZs"
  type        = list(string)
  default     = ["10.2.1.0/24", "10.2.2.0/24", "10.2.3.0/24"]
}

variable "database_subnet_cidrs" {
  description = "CIDR blocks for database subnets - STAGING uses 3 AZs"
  type        = list(string)
  default     = ["10.2.101.0/24", "10.2.102.0/24", "10.2.103.0/24"]
}

variable "additional_allowed_cidrs" {
  description = "Additional CIDR blocks allowed to access EKS cluster"
  type        = list(string)
  default     = []
}

variable "enable_vpc_flow_logs" {
  description = "Enable VPC Flow Logs to S3 - ENABLED in STAGING for testing"
  type        = bool
  default     = true
}
...
variable "node_groups" {
  description = "EKS managed node group configurations - STAGING uses production-like setup"
  type = map(object({
...
variable "sns_topic_arn" {
  description = "SNS topic ARN for CloudWatch alarms - configured for STAGING"
  type        = string
  default     = ""
}

variable "enable_container_insights" {
  description = "Enable CloudWatch Container Insights for EKS - DISABLED in STAGING for cost savings"
  type        = bool
  default     = false
}
...
variable "budget_amount" {
  description = "Monthly budget amount in USD for cost alerts - STAGING uses moderate budget"
  type        = number
  default     = 50
...
variable "enable_automated_backups" {
  description = "Enable automated EBS snapshots - ENABLED in STAGING for testing"
  type        = bool
  default     = true
}

variable "backup_retention_days" {
  description = "Number of days to retain automated backups - STAGING uses moderate retention"
  type        = number
  default     = 3
...
#######################################
# RDS PostgreSQL Configuration - STAGING Optimized
#######################################
variable "rds_instance_class" {
  description = "RDS instance class for PostgreSQL - STAGING uses production-like instance"
  type        = string
...
variable "rds_allocated_storage" {
  description = "Allocated storage for RDS in GB - STAGING uses moderate size"
  type        = number
  default     = 50
...
variable "rds_max_allocated_storage" {
  description = "Maximum storage for RDS autoscaling in GB - STAGING uses moderate max"
  type        = number
  default     = 100
...
variable "rds_backup_retention_period" {
  description = "Backup retention period for RDS in days - STAGING uses moderate retention"
  type        = number
  default     = 3
...
variable "rds_multi_az" {
  description = "Enable multi-AZ deployment for RDS - DISABLED in STAGING for cost savings"
  type        = bool
  default     = false
}
...
variable "rds_skip_final_snapshot" {
  description = "Skip final snapshot when destroying RDS - ENABLED in STAGING for faster teardown"
  type        = bool
  default     = true
}

#######################################
# ElastiCache Redis Configuration - STAGING Optimized
#######################################
variable "redis_node_type" {
  description = "ElastiCache Redis node type - STAGING uses production-like instance"
  type        = string
...
variable "redis_num_cache_nodes" {
  description = "Number of cache nodes for Redis - STAGING uses single node for cost savings"
  type        = number
  default     = 1
...
variable "redis_automatic_failover_enabled" {
  description = "Enable automatic failover for Redis - DISABLED in STAGING (requires multi-node)"
  type        = bool
  default     = false
}

variable "redis_multi_az_enabled" {
  description = "Enable multi-AZ for Redis - DISABLED in STAGING for cost savings"
  type        = bool
  default     = false
}

variable "redis_snapshot_retention_limit" {
  description = "Number of days to retain Redis snapshots - DEV uses minimal retention"
  type        = number
  default     = 1
...
#######################################
# DocumentDB Configuration - DEV Optimized
#######################################
variable "docdb_instance_class" {
  description = "DocumentDB instance class - DEV uses smallest instance"
  type        = string
...
variable "docdb_instance_count" {
  description = "Number of DocumentDB instances - DEV uses single instance"
  type        = number
  default     = 1
...
variable "docdb_backup_retention_period" {
  description = "Backup retention period for DocumentDB - DEV uses minimal retention"
  type        = number
  default     = 1
...
variable "docdb_skip_final_snapshot" {
  description = "Skip final snapshot when destroying DocumentDB - ENABLED in DEV for faster teardown"
  type        = bool
  default     = true
}

variable "docdb_deletion_protection" {
  description = "Enable deletion protection for DocumentDB - DISABLED in DEV for easier teardown"
  type        = bool
  default     = false
}
